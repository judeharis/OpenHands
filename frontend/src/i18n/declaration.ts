...
export enum I18nKey {
  ...
  CONVERSATION$REOPEN = "CONVERSATION$REOPEN",
  CONVERSATION$REOPENING = "CONVERSATION$REOPENING",
  CONVERSATION$SANDBOX_ERROR = "CONVERSATION$SANDBOX_ERROR",
  COMMON$RETRY = "COMMON$RETRY",
  CHAT_INTERFACE$ALLOW_FOR_SESSION = "CHAT_INTERFACE$ALLOW_FOR_SESSION",
  CHAT_INTERFACE$ALLOW_HINT = "CHAT_INTERFACE$ALLOW_HINT",
  CHAT_INTERFACE$PENDING_ACTIONS = "CHAT_INTERFACE$PENDING_ACTIONS",
  CHAT_INTERFACE$REJECT_WITH_REASON = "CHAT_INTERFACE$REJECT_WITH_REASON",
  CHAT_INTERFACE$REASON_PLACEHOLDER = "CHAT_INTERFACE$REASON_PLACEHOLDER",
  CHAT_INTERFACE$SEND_REJECTION = "CHAT_INTERFACE$SEND_REJECTION",
  CHAT_INTERFACE$AUTO_APPROVED_SAME = "CHAT_INTERFACE$AUTO_APPROVED_SAME",
  POLICY$OUTSIDE_WORKSPACE = "POLICY$OUTSIDE_WORKSPACE",
  POLICY$DENY_HINT = "POLICY$DENY_HINT",
  POLICY$GRANT_WRITE = "POLICY$GRANT_WRITE",
  POLICY$GRANT_CMD = "POLICY$GRANT_CMD",
  POLICY$GRANT_TOOL = "POLICY$GRANT_TOOL",
  POLICY$GRANT_KIND = "POLICY$GRANT_KIND",
  POLICY$GRANT_VIEW = "POLICY$GRANT_VIEW",
  SETTINGS$BROWSER_NOTIFICATIONS = "SETTINGS$BROWSER_NOTIFICATIONS",
  MARKDOWN$OPEN_LINK = "MARKDOWN$OPEN_LINK",
  CHAT_INTERFACE$REPEATING = "CHAT_INTERFACE$REPEATING",
  CONVERSATION$BACK_TO_CHAT = "CONVERSATION$BACK_TO_CHAT",
}
